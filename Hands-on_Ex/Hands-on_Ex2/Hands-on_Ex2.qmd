---
title: "Hands-on_Exercise2: 1.Spatial Weights and Applications, 2.Global Measures of Spatial Autocorrelation, 3.Local Measures of Spatial Autocorrelation"
data: "22 November 2023"
...
he code chunk below uses [*st_read()*](https://r-spatial.github.io/sf/reference/st_read.html) of **sf** package to import Hunan shapefile into R. The imported shapefile will be **simple features** Object of **sf**.
...
Next, we will import *Hunan_2012.csv*.
...
Retrieved the GDPPC of these five countries by using the code chunk below.
...
In this hands-on exercise, we will learn how to compute Global and Local Measure of Spatial Autocorrelation (GLSA) by using **spdep** package. By the end to this hands-on exercise, you will be able to:
...
## **3.7 Creating a LISA Cluster Map**
...
## **3.8 Hot Spot and Cold Spot Area Analysis**
